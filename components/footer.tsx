  ...
  return (
    <footer className="bg-gradient-to-b from-[#121212] to-[#0a0a0a] text-gray-300 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          <h4 className="text-lg font-semibold mb-4 text-secondary-foreground">Quick Links</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold mb-4 text-secondary-foreground">Contact Us</h4>
          <ul className="space-y-2">
        ...
        <div>
          <h4 className="text-lg font-semibold mb-4 text-secondary-foreground">Newsletter</h4>
          <p className="text-sm mb-4">Stay up to date with our latest offers and updates</p>
          <form className="flex flex-col sm:flex-row gap-2">
            <input
              type="email"
              placeholder="Your email"
              className="bg-[#1a1a1a] text-secondary-foreground px-4 py-2 rounded-md sm:rounded-l-md sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-[#00a000] w-full"
            />
            <button
              type="submit"
              className="bg-[#008000] text-secondary-foreground px-4 py-2 rounded-md sm:rounded-l-none sm:rounded-r-md hover:bg-[#006000] transition-colors w-full sm:w-auto"
            >
              Subscribe
            </button>
          </form>
