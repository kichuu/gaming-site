...
import { ShoppingCart, Star, ChevronDown, ChevronUp, Grid, List, Eye } from 'lucide-react'
import { ItemCard } from '@/components/ItemCard'  // Changed to ItemCard
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        {/* Filters */}
        <div className={`lg:w-1/4 space-y-6 bg-[#1a1a1a] p-6 rounded-lg transition-all duration-300 ${isFilterOpen ? 'max-h-[2000px]' : 'max-h-16'}`}>
